...
def create_jaiminho_agent(llm: LLM, tool: AzureDevOpsTool) -> Agent:
    return Agent(
        ...
        backstory=(
            ...
            "3) A descrição deve ser Markdown com checklist do que implementar.\n"
...
def create_tasks_task(agent: Agent, stories_task: Task) -> Task:
    return Task(
        description=(
            ...
            "```\n"
            "## Objetivo\n"
            "Descrição clara do que esta task entrega.\n\n"
            "## Checklist de Implementação\n"
            "- [ ] Item 1\n"
            "- [ ] Item 2\n"
            "- [ ] Item 3\n\n"
            "## Camada\n"
            "Infrastructure | Domain | Application | Presentation | Quality\n\n"
            "## Definition of Done\n"
