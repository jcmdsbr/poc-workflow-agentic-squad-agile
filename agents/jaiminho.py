...
def create_jaiminho_agent(llm: LLM, tool: AzureDevOpsTool) -> Agent:
    return Agent(
        ...
        backstory=(
            ...
            "IDIOMA DO CÓDIGO: Todo exemplo de código, nome de classe, interface, método, "
            "propriedade, endpoint e contrato DEVE ser escrito em INGLÊS. "
            "Textos descritivos continuam em português.\n\n"
